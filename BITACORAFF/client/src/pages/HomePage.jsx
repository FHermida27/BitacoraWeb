  ...
  return (
    <div className="home-container">
      <header className="home-header">
        ...
        <p>Documenta el crecimiento, cuidados y observaciones de tus plantas en un solo lugar.</p>
      </header>
      ...
      <section className="home-info">
        ...
        <p>Registrar tus observaciones te ayudará a mantener un mejor cuidado de tus plantas. Puedes seguir su evolución, anotar detalles de riego, condiciones ambientales y cualquier observación importante.</p>
      </section>
      <div className="bitacora-grid">
        {bitacoras.length === 0 ? (
          <p>No hay bitácoras disponibles. Comienza añadiendo una nueva entrada.</p>
        ) : (
